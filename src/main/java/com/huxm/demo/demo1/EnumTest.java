...
public class EnumTest {
	...
	public void test() {
		...
		System.out.println("n2=" + e2.ordinal());
		System.out.println("k1=" + e1.k);
		System.out.println("v2=" + e2.v);
		...
		/*
		 * 段落四:对基本类型数组，通过asList之后的List修改对应的值后,在运行时会报出异常 但是基本类型数组对应的List是会发生变化的，这是毫无疑问的
		 * 
		 * 
		 * a_int_List.set(0,0); foreach(a_int_List);foreach(a_int);
		 */
